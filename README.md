...
3. Some examples are shows for your reference. You need to add more similar elements like radio buttons, checkboxes, buttons, etc and add appropriate styling to those elements. 
